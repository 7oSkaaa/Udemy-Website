    ...
    return (
        <div>
            ...
            <div className="side-bar-container">
                ...
                <div className='child' style={{ position: !isCardAppear ? "fixed" : null, width: !isCardAppear ? "20%" : null, top: isStickyCardDisappear? "-40%" : !isCardAppear ? "10px" : null, zIndex: isStickyCardDisappear ? "0" : "3000" }}>
                <div className="price">
